...
document.getElementById('quiz-form').addEventListener('submit', function(event) {
    ...
    const respuestasCorrectas = {
        ...
        pregunta4: 'Consideras implementar un programa de limpieza más estructurado, asignar horarios específicos para la limpieza profunda del centro de acopio, o proporcionar incentivos para que los vendedores mantengan sus espacios ordenados'
    };
